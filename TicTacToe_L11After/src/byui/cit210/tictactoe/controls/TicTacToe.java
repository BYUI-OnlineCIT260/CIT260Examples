...
import byui.cit210.tictactoe.views.GamePreferencesMenuView;
import byui.cit210.tictactoe.views.HelpMenuView;
import byui.cit210.tictactoe.views.MainMenuView;
...
public class TicTacToe {
    ...
    private String[] getPlayerNames() {
        ...
        while (playerIndex < 10  && !done) { 
            ...
            if (name.length() < 1) {
                System.out.println("\tA name must be at least one character long. Try again.");
                continue;
            }
